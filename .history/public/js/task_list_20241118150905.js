...
// Function to set the task element to be deleted
function setTaskToDelete(taskId) {
    // Store the task element based on the taskId passed
...
function deleteTask() {
    if (taskToDelete) {
        ...
        // Optionally, send an AJAX request to delete the task from the database
