...
function displayMytaskCard(doc) {
    ...
    let addButton = newcard.querySelector('.btn-primary'); // Assuming you have an add button in your template
    addButton.addEventListener('click', function () {
        addTask(doc); // Pass the entire document snapshot to the editTask function
    });
