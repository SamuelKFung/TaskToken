...
function displayMytaskCard(doc) {
    ...
    let editButton = newcard.querySelector('.btn-danger'); // Assuming your button in the template has the class 'btn-danger'
    deleteButton.addEventListener('click', function () {
        editTask(doc.id); // Pass the task ID to delete the task
    });
