...
function displayMytaskCard(doc) {
    ...
    let pillBadgeElement = name + "<span class="badge rounded-pill card-due fs-5 mx-4 mt-auto mb-auto float-end">5 days</span>
" + pillBadgeColor + " float-end\">" + daysUntilDue + " days</span>";
